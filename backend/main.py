...
from routers import resume, career, skills, roadmap, jobmarket, interview, growth, benchmarking, matcher

app = FastAPI(
    title="VidyaGuide AI API",
    description="Agentic AI backend for career planning, resume evaluation, and interview coaching",
    version="1.0.0"
)
...
@app.get("/")
def root():
    return {"message": "VidyaGuide AI API is running 🚀", "docs": "/docs"}
